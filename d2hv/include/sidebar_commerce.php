...
<ul class="traction-nav nav nav-list  ng-scope" data-ng-controller="analyticsSideNavigationController">
    <li class="active">
        <a href=""> <i class="menu-icon fa fa-tachometer"></i> <span class="menu-text">Campaign Dashboard </span> </a>
    </li>
    <li class="">
        <a href=""> <i class="menu-icon fa fa-calendar-check-o"></i> <span class="menu-text">New Campaign</span> </a>
    </li>
    <li class="">
        <a href=""> <i class="menu-icon fa fa-clock-o"></i> <span class="menu-text"> Reports </span> </a>
    </li>
				<li class="">
        <a href=""> <i class="menu-icon fa fa-money"></i> <span class="menu-text"> ... Purchase Report </span> </a>
    </li>   
    <li class="">
        <a href=""> <i class="menu-icon fa fa-money"></i> <span class="menu-text"> ... Revenue Report </span> </a>
    </li>
</ul>
