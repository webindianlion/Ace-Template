...
<ul class="traction-nav nav nav-list  ng-scope" data-ng-controller="analyticsSideNavigationController">
    <li class="active">
        <a href=""> <i class="menu-icon fa fa-tachometer"></i> <span class="menu-text">Business Rules </span> </a>
    </li>
    <li class="">
        <a href=""> <i class="menu-icon fa fa-calendar-check-o"></i> <span class="menu-text">Create Rules</span> </a>
    </li>    
</ul>
